  ...
  return (
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <h1 data-text="I'm Kurubaran Anandhan" className="intro__text">
              <mark className="mark">I&apos;m Kurubaran Anandhan</mark>
            </h1>
            <p>
              An Achievement oriented individual with 2+ years of experience in
              software development. Skilled in designing, developing & testing
